# solaris-backup
backup solaris ui lib

loadstring
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/RealBebramen/solaris-backup/main/lib.lua"))()
```


example
```lua
local SolarisLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/RealBebramen/solaris-backup/main/lib.lua"))()
